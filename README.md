...
* [Verity](https://github.com/th0rgal/verity) ⭐ 148 | 🐛 25 | 🌐 Lean | 📅 2026-09-08 - Lean 4 framework for formally specified and verified smart contracts, with EVM-oriented compilation.
* [Panther](https://github.com/ElNiak/PANTHER) ⭐ 42 | 🐛 21 | 🌐 Python | 📅 2026-09-08 - This tool presents a novel approach to bolstering network protocol verification by integrating the Shadow network simulator with the Ivy formal verification tool to check time properties. Furthermore, it extends Ivy's capabilities with a dedicated time module, enabling the verification of complex quantitative-time properties.
* [ProofOS](https://github.com/Aevion-ai/ProofOS) ⭐ 0 | 🐛 90 | 🌐 Python | 📅 2026-09-08 - Receipt-chained proof obligation ledger for Lean 4. Publishes a machine-readable open-obligation surface (Godel register) with SHA-256 canonical receipts and a multi-agent counsel colony for adversarial review.
...
* [ABC](https://github.com/berkeley-abc/abc) ⭐ 1,218 | 🐛 234 | 🌐 C | 📅 2026-09-06 - ABC: System for Sequential Logic Synthesis and Formal Verification. ABC notably provides combinational equivalence checking (CEC) and sequential equivalence checking (SEQ) engines.
* [riscv-formal](https://github.com/SymbioticEDA/riscv-formal) ⭐ 633 | 🐛 24 | 🌐 Verilog | 📅 2022-04-06 - A re-usable formal verification framework for RISC-V CPU designs.
...
* [Icarus Verilog](https://github.com/steveicarus/iverilog) ⭐ 3,632 | 🐛 186 | 🌐 C++ | 📅 2026-09-09 - The excellent Icarus Verilog simulator. Slower than Verilator, but it supports full 4-state simulation (i.e. X's and Z's).
...
* [FuseSoc](https://github.com/olofk/fusesoc) ⭐ 1,455 | 🐛 150 | 🌐 Python | 📅 2026-09-08 - FuseSoC is an award-winning package manager and a set of build tools for HDL (Hardware Description Language) code. Its main purpose is to increase reuse of IP (Intellectual Property) cores and be an aid for creating, building and simulating SoC solutions.
...
* [riscv-dv](https://github.com/chipsalliance/riscv-dv) ⭐ 1,353 | 🐛 167 | 🌐 Python | 📅 2026-09-04 - Instruction sequence generator for RISC-V.
* [rggen](https://github.com/rggen/rggen) ⭐ 469 | 🐛 23 | 🌐 Ruby | 📅 2026-08-16 - Code generation tool for configuration and status registers.
* [FORCE-RISCV](https://github.com/openhwgroup/force-riscv) ⭐ 314 | 🐛 20 | 🌐 C++ | 📅 2023-10-17 - Instruction sequence generator for RISC-V.
...
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 474 | 🐛 47 | 🌐 C++ | 📅 2026-09-04 - SystemVerilog pre-processor and parser.
* [svlint](https://github.com/dalance/svlint) ⭐ 392 | 🐛 24 | 🌐 Rust | 📅 2025-11-06 - Linter for SystemVerilog.

#### Testbench Frameworks

* [UVVM](https://github.com/UVVM/UVVM) ⭐ 463 | 🐛 23 | 🌐 VHDL | 📅 2026-04-22 - Universal VHDL Verification Methodology.
* [chiselverify](https://github.com/chiselverify/chiselverify) ⭐ 163 | 🐛 8 | 🌐 Scala | 📅 2024-11-09 - UVM-like verification for the Chisel HDL.
* [fvutils/pyvsc](https://github.com/fvutils/pyvsc) ⭐ 148 | 🐛 52 | 🌐 Python | 📅 2026-08-31 - Python packages providing a library for verification stimulus and coverage.
...
* [AXI SystemVerilog Modules and Verification Infrastructure](https://github.com/pulp-platform/axi) ⭐ 1,685 | 🐛 75 | 🌐 SystemVerilog | 📅 2026-09-08 - SystemVerilog modules and verification infrastructure for AXI bus.
* [AXI Bus Functional Model tvip-axi](https://github.com/taichi-ishitani/tvip-axi) ⭐ 476 | 🐛 8 | 🌐 SystemVerilog | 📅 2024-06-28 - Functional model for AXI bus.
...
* [Cocotb Verification IPs](https://github.com/themperek/cocotb-vivado) ⭐ 75 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Various cocotb packages for common interfaces: AXI/Ethernet/PCIE.
...
* [Agda](http://wiki.portal.chalmers.se/agda/pmwiki.php) - Dependently typed functional programming language.
  * [Agda GitHub](https://github.com/agda/agda) ⭐ 2,927 | 🐛 1,041 | 🌐 Haskell | 📅 2026-09-08
