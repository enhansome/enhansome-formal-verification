...
* [Verity](https://github.com/th0rgal/verity) ⭐ 148 | 🐛 37 | 🌐 Lean | 📅 2026-09-23 - Lean 4 framework for formally specified and verified smart contracts, with EVM-oriented compilation.
...
* [ProofOS](https://github.com/Aevion-ai/ProofOS) ⭐ 0 | 🐛 121 | 🌐 Python | 📅 2026-09-23 - Receipt-chained proof obligation ledger for Lean 4. Publishes a machine-readable open-obligation surface (Godel register) with SHA-256 canonical receipts and a multi-agent counsel colony for adversarial review.
...
* [ABC](https://github.com/berkeley-abc/abc) ⭐ 1,228 | 🐛 226 | 🌐 C | 📅 2026-09-24 - ABC: System for Sequential Logic Synthesis and Formal Verification. ABC notably provides combinational equivalence checking (CEC) and sequential equivalence checking (SEQ) engines.
...
* [Icarus Verilog](https://github.com/steveicarus/iverilog) ⭐ 3,655 | 🐛 188 | 🌐 C++ | 📅 2026-09-22 - The excellent Icarus Verilog simulator. Slower than Verilator, but it supports full 4-state simulation (i.e. X's and Z's).
...
* [FuseSoc](https://github.com/olofk/fusesoc) ⭐ 1,463 | 🐛 152 | 🌐 Python | 📅 2026-09-12 - FuseSoC is an award-winning package manager and a set of build tools for HDL (Hardware Description Language) code. Its main purpose is to increase reuse of IP (Intellectual Property) cores and be an aid for creating, building and simulating SoC solutions.
...
* [riscv-dv](https://github.com/chipsalliance/riscv-dv) ⭐ 1,357 | 🐛 170 | 🌐 Python | 📅 2026-09-21 - Instruction sequence generator for RISC-V.
...
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 475 | 🐛 47 | 🌐 C++ | 📅 2026-09-24 - SystemVerilog pre-processor and parser.
...
* [AXI SystemVerilog Modules and Verification Infrastructure](https://github.com/pulp-platform/axi) ⭐ 1,706 | 🐛 62 | 🌐 SystemVerilog | 📅 2026-09-17 - SystemVerilog modules and verification infrastructure for AXI bus.
...
* [Cocotb Verification IPs](https://github.com/themperek/cocotb-vivado) ⭐ 76 | 🐛 4 | 🌐 Python | 📅 2026-09-22 - Various cocotb packages for common interfaces: AXI/Ethernet/PCIE.
...
* [Agda](http://wiki.portal.chalmers.se/agda/pmwiki.php) - Dependently typed functional programming language.
  * [Agda GitHub](https://github.com/agda/agda) ⭐ 2,930 | 🐛 1,055 | 🌐 Haskell | 📅 2026-09-23
