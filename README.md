...
* [Verity](https://github.com/th0rgal/verity) ⭐ 148 | 🐛 28 | 🌐 Lean | 📅 2026-09-17 - Lean 4 framework for formally specified and verified smart contracts, with EVM-oriented compilation.
...
* [ProofOS](https://github.com/Aevion-ai/ProofOS) ⭐ 0 | 🐛 109 | 🌐 Python | 📅 2026-09-17 - Receipt-chained proof obligation ledger for Lean 4. Publishes a machine-readable open-obligation surface (Godel register) with SHA-256 canonical receipts and a multi-agent counsel colony for adversarial review.
...
* [ABC](https://github.com/berkeley-abc/abc) ⭐ 1,225 | 🐛 228 | 🌐 C | 📅 2026-09-17 - ABC: System for Sequential Logic Synthesis and Formal Verification. ABC notably provides combinational equivalence checking (CEC) and sequential equivalence checking (SEQ) engines.
...
* [Icarus Verilog](https://github.com/steveicarus/iverilog) ⭐ 3,643 | 🐛 190 | 🌐 C++ | 📅 2026-09-18 - The excellent Icarus Verilog simulator. Slower than Verilator, but it supports full 4-state simulation (i.e. X's and Z's).
...
* [riscv-dv](https://github.com/chipsalliance/riscv-dv) ⭐ 1,354 | 🐛 168 | 🌐 Python | 📅 2026-09-04 - Instruction sequence generator for RISC-V.
* [rggen](https://github.com/rggen/rggen) ⭐ 469 | 🐛 23 | 🌐 Ruby | 📅 2026-09-11 - Code generation tool for configuration and status registers.
* [FORCE-RISCV](https://github.com/openhwgroup/force-riscv) ⭐ 315 | 🐛 20 | 🌐 C++ | 📅 2023-10-17 - Instruction sequence generator for RISC-V.
...
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 475 | 🐛 47 | 🌐 C++ | 📅 2026-09-17 - SystemVerilog pre-processor and parser.
...
* [Agda](http://wiki.portal.chalmers.se/agda/pmwiki.php) - Dependently typed functional programming language.
  * [Agda GitHub](https://github.com/agda/agda) ⭐ 2,930 | 🐛 1,047 | 🌐 Haskell | 📅 2026-09-17
