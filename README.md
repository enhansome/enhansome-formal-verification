...
* [Verity](https://github.com/th0rgal/verity) ⭐ 148 | 🐛 35 | 🌐 Lean | 📅 2026-09-21 - Lean 4 framework for formally specified and verified smart contracts, with EVM-oriented compilation.
...
* [ProofOS](https://github.com/Aevion-ai/ProofOS) ⭐ 0 | 🐛 117 | 🌐 Python | 📅 2026-09-21 - Receipt-chained proof obligation ledger for Lean 4. Publishes a machine-readable open-obligation surface (Godel register) with SHA-256 canonical receipts and a multi-agent counsel colony for adversarial review.
...
* [ABC](https://github.com/berkeley-abc/abc) ⭐ 1,227 | 🐛 226 | 🌐 C | 📅 2026-09-21 - ABC: System for Sequential Logic Synthesis and Formal Verification. ABC notably provides combinational equivalence checking (CEC) and sequential equivalence checking (SEQ) engines.
...
* [Icarus Verilog](https://github.com/steveicarus/iverilog) ⭐ 3,650 | 🐛 187 | 🌐 C++ | 📅 2026-09-20 - The excellent Icarus Verilog simulator. Slower than Verilator, but it supports full 4-state simulation (i.e. X's and Z's).
...
* [riscv-dv](https://github.com/chipsalliance/riscv-dv) ⭐ 1,357 | 🐛 168 | 🌐 Python | 📅 2026-09-21 - Instruction sequence generator for RISC-V.
...
* [UVVM](https://github.com/UVVM/UVVM) ⭐ 464 | 🐛 23 | 🌐 VHDL | 📅 2026-04-22 - Universal VHDL Verification Methodology.
...
* [AXI SystemVerilog Modules and Verification Infrastructure](https://github.com/pulp-platform/axi) ⭐ 1,704 | 🐛 62 | 🌐 SystemVerilog | 📅 2026-09-17 - SystemVerilog modules and verification infrastructure for AXI bus.
...
* [Agda](http://wiki.portal.chalmers.se/agda/pmwiki.php) - Dependently typed functional programming language.
  * [Agda GitHub](https://github.com/agda/agda) ⭐ 2,930 | 🐛 1,052 | 🌐 Haskell | 📅 2026-09-20
