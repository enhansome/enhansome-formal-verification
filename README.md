...
* [Panther](https://github.com/ElNiak/PANTHER) ⭐ 42 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - This tool presents a novel approach to bolstering network protocol verification by integrating the Shadow network simulator with the Ivy formal verification tool to check time properties. Furthermore, it extends Ivy's capabilities with a dedicated time module, enabling the verification of complex quantitative-time properties.
* [ProofOS](https://github.com/Aevion-ai/ProofOS) ⭐ 0 | 🐛 78 | 🌐 Python | 📅 2026-09-02 - Receipt-chained proof obligation ledger for Lean 4. Publishes a machine-readable open-obligation surface (Godel register) with SHA-256 canonical receipts and a multi-agent counsel colony for adversarial review.
...
* [ABC](https://github.com/berkeley-abc/abc) ⭐ 1,216 | 🐛 231 | 🌐 C | 📅 2026-09-02 - ABC: System for Sequential Logic Synthesis and Formal Verification. ABC notably provides combinational equivalence checking (CEC) and sequential equivalence checking (SEQ) engines.
...
* [Surelog](https://github.com/chipsalliance/Surelog) ⭐ 473 | 🐛 48 | 🌐 C++ | 📅 2026-09-02 - SystemVerilog pre-processor and parser.
...
* [AXI SystemVerilog Modules and Verification Infrastructure](https://github.com/pulp-platform/axi) ⭐ 1,677 | 🐛 75 | 🌐 SystemVerilog | 📅 2026-08-27 - SystemVerilog modules and verification infrastructure for AXI bus.
...
* [Agda](http://wiki.portal.chalmers.se/agda/pmwiki.php) - Dependently typed functional programming language.
  * [Agda GitHub](https://github.com/agda/agda) ⭐ 2,922 | 🐛 1,037 | 🌐 Haskell | 📅 2026-09-02
